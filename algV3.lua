--[[Anotações resultantes da união entre as 
	...
	da gramática gerada pelo algoritmo soft.

	3 labels a mais
	45 labels a menos (cerca de x% a menos)
...
local grammar = [[
	...
	subrangeType 			<- const DotDot^Err_016 const^ConstErr
	...
	varDecs 				<- (VAR varDec^Err_030 Semi^SemiErr (varDec Semi^SemiErr)*)?
